...
public class PlayerController extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
     ...
     * 设置播放状态
     *
     * @param curPlayState 参考 {@link com.t.videoview.videoplay.constant.PlayState}
     */
     ...
     *                    <ol>
     *                    <li>{@link com.t.videoview.videoplay.util.OrientationUtil#HORIZONTAL HORIZONTAL}</li>
     *                    <li>{@link com.t.videoview.videoplay.util.OrientationUtil#VERTICAL VERTICAL}</li>
     *                    </ol>
     */
